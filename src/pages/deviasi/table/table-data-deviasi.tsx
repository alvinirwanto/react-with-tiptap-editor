...
import { ColumnsTableDataDeviasi } from "./columns-table-data-deviasi";
...
export default function TableDataDeviasi() {
    ...
    const columns = useMemo(() => ColumnsTableDataDeviasi(refetch), []);
    ...
    return (
        <div className="flex flex-col gap-3 w-full h-full">
            ...
            <div className="w-full bg-white overflow-hidden rounded-tl-md rounded-tr-md">
                <DataTable
                    qa="table-management-peserta"
                    columns={columns}
                    data={dataEvent || []}
                    isLoading={isLoading || isFetching}
                    rightColumnPinning={["id_peserta"]}
