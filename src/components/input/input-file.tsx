...
import { ArrowUpFromLine, CloudUpload, FileText, Pencil, Trash2 } from 'lucide-react';
                                ...
                                : <>
                                    ...
                                    <div
                                        ...
                                        className={cn(
                                            ...
                                            fieldState.error ? 'border border-rose-500 bg-rose-100' : 'border border-gray-300',
                                            disabled && 'bg-gray-200'
                                        )}
                                    >
                                        ...
                                        >
                                            {
                                                selectedFile
                                                    ? <span className='text-sm text-center text-blue-pnm font-medium'>{clipText(selectedFile?.name, 40)}</span>
